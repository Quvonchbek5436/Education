...
const HeaderLanding = () => {
    ...
    return (
        <HeaderComp>
            ...
            <a href="/" className="logo"> <i className="fa fa-graduation-cap"></i> {educations.filter((edu) => edu.id.toString() === eduId)[0].educationName}</a>

            <nav className="navbar">
                <a href="#hero">Biz haqimizda</a>
                <a href="#servies">Afzallik</a>
                <a href="#direct">Yo'nalishlar</a>
                <a href="#pricing">Kurslar</a>
                <a href="#teacher">Mentorlar</a>
